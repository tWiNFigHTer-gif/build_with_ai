...
export function TeacherPlanner({ syllabusUri, branchId }: Props) {
  ...
  return (
    <section>
      <h2>Teacher Planning Assistant</h2>
      <p>Generate AI checklist suggestions and edit them manually anytime.</p>
      <input
        type="text"
        value={prompt}
      ...
      <h3>Live Class Progress</h3>
      <p>Active students studying: {liveStats.activeStudents}</p>
      <p>Total study time (live): {formatStudyTime(liveStats.totalStudySeconds)}</p>
      <p>Checklist completion: {overallCompletion}%</p>

      <h3>Day Checklist ({dayCompletion}%)</h3>
      ...
      <h3>Week Checklist ({weekCompletion}%)</h3>
